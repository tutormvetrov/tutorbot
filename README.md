...
Telegram-бот для управления учебным процессом: регистрация учеников, родителей и учебных пар, расписание, домашние задания, учебные планы, оплаты, напоминания и админ-панель.
...
- Учебные пары: саморегистрация пары, создание пары из админки, deep-link для второго участника, общий баланс, темп, ДЗ и учебный план через основной профиль.
- Домашние задания: вложения, отложенная доставка в тихие часы, кнопка `Отправить сейчас`, утренняя пакетная доставка и reply-flow по ДЗ.
- Родительский кабинет: дети, расписание, ДЗ, оплаты, реквизиты и учебный план ребёнка.
- Оплаты: учёт баланса, история оплат, глобальная тарифная сетка по размеру группы и длительности занятия.
- Админ-панель: ученики, пары, родители, учебный процесс, рассылки, preview ролей, мониторинг, рабочие заметки и операционные экраны.
...
Текущий ориентир покрытия после релиза учебного плана: `make check` проходит с 188 тестами.
...
9. тарифы: `Учебный процесс` -> `💳 Тарифы`, затем `Реквизиты` у ученика.
